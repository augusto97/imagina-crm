...
/**
 * Inspector panel cuando hay más de un bloque seleccionado
 * (Fase 11.D · multi-select).
 *
 * Muestra un resumen de la selección + acciones bulk: duplicar
 * todos, eliminar todos. Las propiedades individuales no son
 * editables en bulk porque cada tipo de bloque tiene su propio
 * shape de config — la UX se vuelve confusa muy rápido.
 *
 * Los atajos Cmd/Ctrl+D y Backspace/Delete tienen el mismo efecto
 * que estos botones.
 */
