 ...
 *
 * El SVG usa `preserveAspectRatio="none"` y ocupa toda la altura del
 * widget — antes era altura fija (h-24 = 96px) y se veía minúsculo
 * cuando el usuario agrandaba el widget en la grilla.
 *
 * Toggles del widget:
    ...
    return (
        <div className="imcrm-flex imcrm-w-full imcrm-flex-col imcrm-gap-1 imcrm-min-h-0">
            ...
            <svg
                ...
                className="imcrm-w-full imcrm-flex-1 imcrm-min-h-0"
                role="img"
