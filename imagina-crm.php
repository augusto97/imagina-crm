...
define('IMAGINA_CRM_VERSION', '0.28.0+sha.10a4598');
...
//        de índice MySQL no-unique sobre la columna del field — 0.28.0).
define('IMAGINA_CRM_DB_VERSION', '5');
